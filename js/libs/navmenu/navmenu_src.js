    ...
    var methods = {
        init: function (options) {
            return this.each(function () {
                ...
                else if(_NB.hasClass('asMenuFromPhoneL'))
                    menuFrom = DeviceTypes.phoneL;
                ...
                if (!data) {
                    ...
                    $navmenu.on('click', '.navbarmenubtn', function (e) {
                        ...
                        if(_dt === DeviceTypes.tablet && menuFrom !== DeviceTypes.desktop && menuFrom !== DeviceTypes.tablet)
                            return;
                        if(_dt === DeviceTypes.phoneL && menuFrom !== DeviceTypes.desktop && menuFrom !== DeviceTypes.tablet && menuFrom !== DeviceTypes.phoneL)
                            return;
                        if(_dt === DeviceTypes.phone && menuFrom !== DeviceTypes.desktop && menuFrom !== DeviceTypes.tablet && menuFrom !== DeviceTypes.phoneL && menuFrom !== DeviceTypes.phone)
                            return;
